...
/**
 * This class represent the SIL model for the user model in the wind turbine
 *
 * @author Emilie SIAU
 * @author Hugo GUERRIER
 */
public class WindTurbineUserSILModel
    extends AtomicModel
{
    ...
    public static final String URI = WindTurbineUserSILModel.class.getSimpleName();
    ...
    public WindTurbineUserSILModel(String uri, TimeUnit simulatedTimeUnit, SimulatorI simulationEngine) throws Exception {
    ...
    public void	userDefinedInternalTransition(Duration elapsedTime) {
        ...
        switch (currentStep) {
            ...
            case 1:
                ...
                msg.append(" executes the operation blockTurning");
                break;
            ...
            case 2:
                ...
                msg.append(" executes the operation unblockTurning");
                break;
