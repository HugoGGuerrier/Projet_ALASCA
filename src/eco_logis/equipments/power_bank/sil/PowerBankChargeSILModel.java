...
public class PowerBankChargeSILModel
    extends PowerBankChargeModel
{
    ...
    /** @see PowerBankChargeModel#PowerBankChargeModel(String, TimeUnit, SimulatorI) */
    public PowerBankChargeSILModel(String uri, TimeUnit simulatedTimeUnit, SimulatorI simulationEngine) throws Exception {
    ...
    /** @see PowerBankChargeModel#setSimulationRunParameters(Map) */
    @Override
